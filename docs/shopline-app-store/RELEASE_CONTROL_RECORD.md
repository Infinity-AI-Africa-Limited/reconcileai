...
| App subscription topics | Caveat | Registration code is deployed, but the development-store package offers no no-charge lifecycle activation control. | Support route or owner acceptance required before review submission. |
