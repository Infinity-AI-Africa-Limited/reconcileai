...
const DEMO_DISTRIBUTORS = [
  ...
  {
    canonicalName: "Port Harcourt Mega Distributors",
    registeredBusinessName: "Port Harcourt Mega Distributors Nigeria Ltd",
    taxId: "RC-1038596",
    primaryBankName: "GTBank",
    primaryBankAccount: "7089012345",
    contactPhone: "+234-811-234-5678",
    zone: "Port Harcourt",
    nameVariants: ["PH Mega Dist", "Port Harcourt Mega", "PHMDN Ltd", "PH MEGA DISTRIBUTORS"],
  },
  {
    canonicalName: "Enugu Central Supplies",
    registeredBusinessName: "Enugu Central Supplies & Trading Ltd",
    taxId: "RC-1149607",
    primaryBankName: "Access Bank",
    primaryBankAccount: "8090123456",
    contactPhone: "+234-812-345-6789",
    zone: "Enugu",
    nameVariants: ["Enugu Central", "ECS Trading", "Enugu Central Supplies & Trading"],
  },
  {
    canonicalName: "Kaduna Allied Merchants",
    registeredBusinessName: "Kaduna Allied Merchants Company Ltd",
    taxId: "RC-1250718",
    primaryBankName: "Zenith Bank",
    primaryBankAccount: "9001234567",
    contactPhone: "+234-813-456-7890",
    zone: "Kaduna",
    nameVariants: ["Kaduna Allied", "KAM Company", "KADUNA ALLIED MERCH"],
  },
  {
    canonicalName: "Benin City Wholesale Hub",
    registeredBusinessName: "Benin City Wholesale Hub Nigeria Ltd",
    taxId: "RC-1361829",
    primaryBankName: "UBA",
    primaryBankAccount: "0112345678",
    contactPhone: "+234-814-567-8901",
    zone: "Benin City",
    nameVariants: ["Benin Wholesale", "BCWH Nigeria", "Benin City Wholesale"],
  },
  {
    canonicalName: "Maiduguri Trade Partners",
    registeredBusinessName: "Maiduguri Trade Partners Ltd",
    taxId: "RC-1472930",
    primaryBankName: "First Bank",
    primaryBankAccount: "1123456789",
    contactPhone: "+234-815-678-9012",
    zone: "Maiduguri",
    nameVariants: ["Maiduguri Trade", "MTP Ltd", "MAIDUGURI TRADE PARTNERS"],
  },
  {
    canonicalName: "Calabar Coastal Distributors",
    registeredBusinessName: "Calabar Coastal Distributors Nigeria Ltd",
    taxId: "RC-1583041",
    primaryBankName: "Stanbic IBTC",
    primaryBankAccount: "2134567890",
    contactPhone: "+234-816-789-0123",
    zone: "Calabar",
    nameVariants: ["Calabar Coastal", "CCD Nigeria", "Calabar Dist"],
  },
];
...
export async function seedDemoData(userId: number, orgId: number | null): Promise<DemoSeedResult> {
  ...
  const memorySeeds = [
    ...
    {
      category: "amount_mismatch",
      transactionRef: "INV-2801",
      amountRange: "1m+" as const,
      deductionType: "contra_entry",
      resolution: "Contra entry identified: ₦500,000 offset against a credit note from previous month. Net settlement confirmed.",
      outcome: "resolved" as const,
      reasoning: "Distributor offset current invoice against an outstanding credit note from the prior month. Finance confirmed the credit note reference. Net position is zero.",
      embeddingText: "contra entry credit note offset prior month net settlement amount mismatch distributor",
    },
    {
      category: "missing_counterparty",
      transactionRef: "UNK-0067",
      amountRange: "100k-1m" as const,
      deductionType: undefined,
      resolution: "Identity confirmed via phone verification. 'DELTA DIST LTD' mapped to Delta Distributors Ltd. Alias added.",
      outcome: "resolved" as const,
      reasoning: "Bank truncated the counterparty name to 'DELTA DIST LTD'. Finance officer confirmed identity via phone. Alias added to Distributor Registry to prevent recurrence.",
      embeddingText: "missing counterparty truncated bank name phone verification alias registry delta distributors",
    },
  ];
