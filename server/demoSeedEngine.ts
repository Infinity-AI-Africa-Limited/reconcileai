...
const FINSERV_PAYMENT_RAILS = [
  ...
  { code: "POS_TERMINAL", label: "POS Terminal (Interswitch/Visa/Mastercard)", channelType: "card_scheme" as const, prefix: "POS" },
  ...
  { code: "DIRECT_DEBIT", label: "Direct Debit (Mandate)", channelType: "direct_debit" as const, prefix: "DD" },
  { code: "CARD_PAYMENT", label: "Card Payment (Debit/Credit)", channelType: "card_scheme" as const, prefix: "CARD" },
